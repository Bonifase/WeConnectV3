/**
 * React Refresh indicator is used when showing an item is loading. It is kept hidden from the interface until it's status prop is changed to loading or ready.
 * More information at [material-ui.com](http://www.material-ui.com/#/components/refresh-indicator)
 */
import React, {Component} from 'react';
import PropTypes from 'prop-types';
import autoPrefix from 'bit/styles/auto-prefix';
import transitions from 'bit/styles/transitions';
import Paper from 'bit/paper/paper';
...
class RefreshIndicator extends Component {
  static propTypes = {
    ...
    /**
     * @property {PropTypes.number.isRequired} left - The absolute left position of the indicator in pixels.
     */
    ...
    /**
     * @property {PropTypes.oneOf(['ready', 'loading', 'hide'])} status - The display status of the indicator. If the status is
    ...
    /**
     * @property {PropTypes.number.isRequired} top - The absolute top position of the indicator in pixels.
     */
